                                ...
                                <form>
                                    <div className="form-group">
                                        ...
                                        <input type="text" name="username" className="form-control"
                                               value={username.value} onChange={this.handleChange}
                                               placeholder="Enter username"/>
                                    </div>
                                    <div className="form-group">
                                        <label>Password</label>
                                        <input type="password" name="password" className="form-control"
                                               value={password.value} onChange={this.handleChange}
                                               id="exampleInputPassword1" placeholder="Password"/>
                                    </div>
                                    <div className="container">
                                        <div className="row" align="center">
                                            <button type="submit"
                                                    className="btn btn-primary col-sm-10 col-md-9 col-xs-12"
                                                    onClick={this.handleLogin}>Login
                                            </button>
                                            &nbsp;&nbsp;
                                            <span className="button-span"></span>
                                            <button type="submit"
                                                    className="btn btn-success col-sm-10 col-md-9 col-xs-12"
                                                    onClick={this.handleClickOpen}>Register
                                            </button>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <form>
                                    <div className="form-group">
                                        ...
                                        <input type="text" name="name" className="form-control"
                                               onChange={this.handleChange} value={name.value}
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" name="nic" className="form-control"
                                               onChange={this.handleChange} value={nic.value} placeholder="Enter NIC"/>

                                    </div>
                                    <div className="form-group">
                                        <label for="exampleInputPassword1">Date of Birth</label>
                                        <input type="date" name="dob" className="form-control"
                                               onChange={this.handleChange} value={dob.value}
                                               placeholder="Enter Date of Birth"/>
                                    </div>
                                    <div className="form-group">
                                        <label for="exampleFormControlSelect1">Type</label>
                                        <select className="form-control" name="type" id="exampleFormControlSelect1"
                                                onChange={this.handleChange} value={type.value}>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select className="form-control" name="role" id="exampleFormControlSelect1"
                                                onChange={this.handleChange} value={role.value}>
                                            <option>Choose..</option>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" name="newUsername" value={newUsername.value}
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="password" name="newPassword" onChange={this.handleChange}
                                               value={newPassword.value} className="form-control"
                                               placeholder="New password"/>
                                    </div>
                                    <div className="form-group">
                                        <label for="exampleInputPassword1">Confirm Password</label>
                                        <input type="password" name="confirmPassword" onChange={this.handleChange}
                                               value={confirmPassword.value} className="form-control"
                                               placeholder="Confirm password"/>
                                    </div>
                                    <div className="container">
                                        <div className="row">
                                            <button type="submit"
                                                    className="btn btn-success col-sm-10 col-md-5 col-xs-12"
                                                    onClick={this.handleSignUp}>Register
                                            </button>
                                        </div>
                                    </div>
                                    <br/>
